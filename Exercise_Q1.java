...
public class Exercise_Q1 extends Frame
{
	public static void main(String[] args){new Exercise_Q1();}
	
	Exercise_Q1()
	{
		super("Two rotating cubes");
		addWindowListener(new WindowAdapter()
			{public void windowClosing(WindowEvent e)
				{System.exit(0);}});
		add("Center", new CvExercise_Q1());
		Dimension dim = getToolkit().getScreenSize();
		setSize(3 * dim.width/6, dim.height/3);
		setLocation(dim.width/8, dim.height/4);
		show();		
	}
}

class CvExercise_Q1 extends Canvas implements Runnable
{
